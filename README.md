...
By cloning this project and the backend that is in a separate repo in my GitHub profile, you are ready to start exploring what you can do with Google Ads API.